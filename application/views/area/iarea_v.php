...
<div class='title'><?php echo $title?></div>
    <table class='myform' style='width:100%' border="0">
        <tr>
            ...
            <td class='a_left'>
				<input type='text' name='nama' value='<?php echo $this->input->post('nama')?>' size='50'/>
        ...
        <tr>
            ...
            <td class='a_left'>
				<input type='text' name='foto' id='file' readonly value='<?php echo $this->input->post('foto')?>' size='30'/>
		...
		<tr>
            ...
            <td class='a_left'>
				<input type='text' name='koordinat1' value='<?php echo $this->input->post('koordinat1')?>' size='5' /> ,
				<input type='text' name='koordinat2' value='<?php echo $this->input->post('koordinat2')?>' size='5' /> contoh : 900, 610
		...
		<tr>
            ...
            <td class='a_left'>
				<textarea name='tooltip' cols='50' rows='2'><?php echo $this->input->post('tooltip')?></textarea>
		...
		<tr>
            ...
            <td class='a_left'>
				<textarea name='keterangan' cols='90' rows='4'><?php echo $this->input->post('keterangan')?></textarea>
		...
		<tr>
			...
			<td colspan='3'>
				<div class='the_footer a_left'>
					<input type='submit' class='button buttonblue smallbtn' name='simpan' value='Simpan'/>
